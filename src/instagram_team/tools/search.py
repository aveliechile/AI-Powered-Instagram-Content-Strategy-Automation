...
class SearchTools:
  ...
  def open_page(url: str) -> str:
    """
    Use this tool to open a webpage and get the content. Usually used after search.
    """
...
if __name__ == "__main__":
  ...
  # print(SearchTools.search_internet("Motivational Quotes About Obsession"))
  # print(SearchTools.search_instagram("Motivational Quotes About Obsession"))
